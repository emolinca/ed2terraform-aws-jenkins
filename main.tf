...
module "elastic_beanstalk_application" {
  source      = "git::https://github.com/emolinca/ed2terraform-aws-elastic-beanstalk-application.git?ref=tags/0.1.6"
...
module "elastic_beanstalk_environment" {
  source        = "git::https://github.com/emolinca/ed2terraform-aws-elastic-beanstalk-environment.git?ref=tags/0.11.0"
  namespace     = "${var.namespace}"
  name          = "${var.name}"
  stage         = "${var.stage}"
  zone_id       = "${var.zone_id}"
...
module "ecr" {
  source     = "git::https://github.com/emolinca/ed2terraform-aws-ecr.git?ref=tags/0.6.0"
  namespace  = "${var.namespace}"
  name       = "${var.name}"
  stage      = "${var.stage}"
  delimiter  = "${var.delimiter}"
...
module "efs" {
  source             = "git::https://github.com/emolinca/ed2terraform-aws-efs.git?ref=tags/0.9.0"
  namespace          = "${var.namespace}"
  name               = "${var.name}"
  stage              = "${var.stage}"
...
# EFS backup to S3
module "efs_backup" {
  source                             = "git::https://github.com/emolinca/ed2terraform-aws-efs-backup.git?ref=tags/0.9.0"
  name                               = "${var.name}"
  stage                              = "${var.stage}"
  namespace                          = "${var.namespace}"
...
module "cicd" {
  source              = "git::https://github.com/emolinca/ed2terraform-aws-cicd.git?ref=tags/0.6.0"
  namespace           = "${var.namespace}"
  name                = "${var.name}"
  stage               = "${var.stage}"
  app                 = "${module.elastic_beanstalk_application.app_name}"
...
module "label_slaves" {
  source     = "git::https://github.com/emolinca/ed2terraform-null-label.git?ref=tags/0.7.0"
  namespace  = "${var.namespace}"
  name       = "${var.name}"
  stage      = "${var.stage}"
  delimiter  = "${var.delimiter}"
